...
function ApprovalsView() {
    ...
    useEffect(() => {
        const fetchPO = async () => {
            ...
            setError(null);
            try {
                // Static data - replace with actual static data service
                const mockData = {
                    po_number: 'PO-001',
                    approval_status: [
                        {
                ...
                let steps = [];
                if (Array.isArray(mockData.approval_status)) {
                    steps = mockData.approval_status
                        .filter((s) => s && typeof s === 'object' && s.status && s.trail)
                        .map((s) => ({
                            status: s.status,
                            trail: s.trail,
                ...
                setPoNumber(mockData.po_number || '');
