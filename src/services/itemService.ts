...
// Define response structure for item configurations
...
// Define response structure for simple data
...
export const deleteItem = async (id: string): Promise<boolean> => {
  try {
    await apiClient.delete<SimpleResponse>(`/items/${id}`);
    return true;
  } catch (error) {
...
export const getItemConfigurations = async (
  ...
  try {
    ...
    const response = await apiClient.get<PaginatedItemConfigsResponse>(`/item-configurations?${params.toString()}`);
    return response;
  } catch (error) {
...
export const getItemConfigurationById = async (id: string): Promise<ItemConfigResponse> => {
  try {
...
export const createItemConfiguration = async (configData: ItemConfigData): Promise<ItemConfigResponse> => {
  try {
...
export const createMultipleItemConfigurations = async (configData: ItemConfigData[]): Promise<ItemConfigResponse> => {
  try {
...
export const updateItemConfiguration = async (id: string, configData: Partial<ItemConfigData>): Promise<ItemConfigResponse> => {
  try {
...
export const deleteItemConfiguration = async (id: string): Promise<boolean> => {
  try {
    await apiClient.delete<SimpleResponse>(`/item-configurations/${id}`);
    return true;
  } catch (error) {
...
export const getCategories = async (): Promise<SimpleResponse> => {
  try {
    const response = await apiClient.get<SimpleResponse>('/categories');
    return response;
  } catch (error) {
...
export const getVendors = async (): Promise<SimpleResponse> => {
  try {
    const response = await apiClient.get<SimpleResponse>('/vendors');
    return response;
  } catch (error) {
